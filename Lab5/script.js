...
function createTable(){
    ...
    document.write("<h4 class='text-start h3 mt-4'>1. Tabla con números</h4>");
    document.write("<table class='table table-hover table-responsive'>");
...
function calculateNumber(){
    ...
    document.write("<section>");
    document.write("<h4 class='text-start h3 mt-4'>2. Adivinar el número</h4>");
    document.write("<ul class='mt-3'>");
...
function counter(numbers){
    ...
    document.write("<section>");
    document.write("<h4 class='text-start h3 mt-4'>3. Contar números</h4>");
    document.write("<p class='lh-base mt-3'>En la lista: " + numbers + " existe: </p>");
    document.write("<ul class='mt-3'>");
...
function average(matrix){
    ...
    document.write("<section>");
    document.write("<h4 class='text-start h3 mt-4'>4. Promedio de una matriz</h4>");
    document.write("<p class='lh-base mt-3'>Los promedios de las filas de las matrices son: </p>");
    for (let i = 0; i < matrix.length; i++){
...
function reverseFunction(number){
    ...
    document.write("<section>");
    document.write("<h4 class='text-start h3 mt-4'>5. Inverso de un número</h4>");
    document.write("<p class='lh-base mt-3'>El reverso del número " + number + " es <strong>" + reversedNumber + "</strong></p>");
    document.write("</section>");
}
...
function problem(){
    ...
    document.write("<section>");
    document.write("<h4 class='text-start h3 mt-4'>6. Solución para un problema</h4>");
    document.write("<p class='lh-base mt-3'>Tienes una lista de transacciones financieras y deseas realizar varias operaciones de procesamiento de datos</p>");
    document.write("<ul class='mt-3'>");
